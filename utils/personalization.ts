...
const CONDITION_SYMPTOM_MAP: Record<string, string[]> = {
  'physical-injury': ['lingering tissue damage', 'scar tissue adhesions', 'movement restrictions'],
  'post-traumatic-pain': ['pain flare-ups after activity', 'sensitivity in injured area', 'protective guarding'],
  whiplash: ['neck stiffness', 'headaches', 'dizziness'],
  'tendon-ligament-pain': ['joint instability', 'tendon soreness', 'loss of strength'],
  'chronic-back-neck': ['persistent tightness', 'limited mobility', 'aching or throbbing pain'],
  osteoarthritis: ['joint grinding', 'swelling', 'morning stiffness'],
  'degenerative-bone': ['bone-on-bone grinding', 'sharp joint pain', 'reduced range of motion'],
  'herniated-disc': ['radiating nerve pain', 'numbness or tingling', 'leg or arm weakness'],
  'bulging-disc': ['localized back pain', 'nerve compression symptoms', 'activity-related flare-ups'],
  'spinal-stenosis': ['leg heaviness', 'balance challenges', 'nerve irritation'],
  'phantom-limb': ['burning or shooting sensations', 'tingling', 'perceived limb position changes'],
  sciatica: ['radiating leg pain', 'pins and needles', 'lower-back electric shocks'],
  'sacroiliac-dysfunction': ['pelvic instability', 'hip pain', 'lower-back stiffness'],
  'spontaneous-pain': ['sudden onset pain', 'flare-ups without clear triggers', 'diffuse discomfort'],
  'pelvic-pain': ['pelvic pressure', 'deep aching', 'pain with movement'],
  'chronic-fatigue': ['severe fatigue', 'post-exertional malaise', 'cognitive fog'],
  'autoimmune-disease': ['systemic inflammation', 'fluctuating pain', 'immune flare-ups'],
  fibromyalgia: ['widespread tenderness', 'sleep disturbances', 'fatigue'],
  'infectious-disease': ['systemic symptoms', 'immune overactivation', 'viral or bacterial complications'],
  'traumatic-brain-injury': ['neurological pain', 'sensory overload', 'cognitive fatigue'],
  'endocrine-disorder': ['hormonal imbalances', 'temperature sensitivity', 'metabolic discomfort'],
  'gastrointestinal-disorder': ['abdominal pain', 'digestive inflammation', 'visceral hypersensitivity'],
  'cancer-pain': ['disease-related pain', 'treatment side effects', 'systemic inflammation'],
  'rheumatoid-arthritis': ['joint inflammation', 'immune flare-ups', 'systemic fatigue'],
};
